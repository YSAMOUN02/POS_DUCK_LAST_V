...
<body>
    @verbatim
        ...
        <div class="gc-report">
            ...
            <!-- HTML comment, not Blade: this whole file sits inside @verbatim,
                 so {{-- --}} would print on the page instead of being stripped.
                 Drill-down modal, filled by renderModal() when a KPI card,
                 chart point or table row is clicked. -->
        ...
        <script>
            ...
            (function() {
                ...
                function init() {
                    ...
                    // Dismiss the drill-down modal: click the backdrop, or Escape.
                    $('modalOv').onclick = e => {
               ...
               function renderKpis() {
                ...
                /* ---------------- detail modal (content rendered inside the modal) ----------------
                   Drill-down for KPI cards, chart points/bars, product rows and
                   the expense legend — about fifteen call sites. The standalone
                   "Transaction Detail" explorer section that also used this modal
                   was removed; the modal itself stays, because the click-through
                   from the charts and cards is a separate feature. */
